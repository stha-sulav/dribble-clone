      ...
      <div className="flex flex-col gap-12 w-full">
        <div className="flex items-start flex-col">
          <Image
            ...
            alt="Flexible"
          />
          <p className="text-start text-sm font-normal mt-5 mx-w-sm">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vero totam
            quo unde, suscipit dolores neque eveniet ducimus non necessitatibus
            sequi eligendi reiciendis culpa placeat quos!
          </p>
        </div>
